...
## Data Visualization
#merging the data
#For the following data, we decided to filter the information down to 2010-2015 because 30 GB is way too much, the following code is how we shrunk the data. 
